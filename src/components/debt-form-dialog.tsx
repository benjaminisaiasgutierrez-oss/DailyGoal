  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <DebtFormBody key={open ? "open" : "closed"} debt={debt} onDone={() => setOpen(false)} />
      </DialogContent>
    </Dialog>
  );
}

function DebtFormBody({ debt, onDone }: { debt?: Debt; onDone: () => void }) {
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="flex gap-2">
          <button
            ...
            aria-pressed={installmentsMode === "count"}
            className={cn(
          ...
          <button
            ...
            aria-pressed={installmentsMode === "fixed"}
            className={cn(
              "flex-1 rounded-md border px-3 py-1.5 text-sm transition-colors",
